...
namespace SQLServerViewTests
{
    ...
    public class MockParentView
    {
        ...
        public void InitialMock()
        {
            ...
            {
                new ExamForGroup() {Id = 1, IDExamTerm = 1, IDGroupe= 1, IDSubjects = 1, DateGroupeExam = new DateTime( 2020,07, 28, 13, 03,24)},
                new ExamForGroup() {Id = 2, IDExamTerm = 1, IDGroupe= 2, IDSubjects = 2, DateGroupeExam = new DateTime( 2020,06, 27, 13, 03,24)},
                new ExamForGroup() {Id = 3, IDExamTerm = 1, IDGroupe= 1, IDSubjects = 3, DateGroupeExam = new DateTime( 2020,04, 26, 13, 03,24)},
                new ExamForGroup() {Id = 4, IDExamTerm = 1, IDGroupe= 2, IDSubjects = 4, DateGroupeExam = new DateTime( 2020,05, 25, 13, 03,24)},
                new ExamForGroup() {Id = 5, IDExamTerm = 2, IDGroupe= 1, IDSubjects = 1, DateGroupeExam = new DateTime( 2020,06, 24, 13, 03,24)},
                new ExamForGroup() {Id = 6, IDExamTerm = 2, IDGroupe= 2, IDSubjects = 2, DateGroupeExam = new DateTime( 2020,03, 23, 13, 03,24)},
                new ExamForGroup() {Id = 7, IDExamTerm = 2, IDGroupe= 1, IDSubjects = 3, DateGroupeExam = new DateTime( 2020,02, 22, 13, 03,24)},
            };
            ...
            {
                new Subjects(){Id=1,SubjectsName="Phisic"},
                new Subjects(){Id=2,SubjectsName="Philosophy"},
                new Subjects(){Id=3,SubjectsName="Math"},
                new Subjects(){Id=4,SubjectsName="Chemistry"},
                new Subjects(){Id=5,SubjectsName="Language"},
                new Subjects(){Id=6,SubjectsName="Astronomy"}
            };
            Mock = new Mock<IView>();
